class ZJMQMI_CL_UPLOAD_HELPER_1ST definition
  public
  final
  create public .
...
public section.
  ...
  types:
    ty_filter_lots TYPE STANDARD TABLE OF qals-prueflos WITH EMPTY KEY .
...
CLASS ZJMQMI_CL_UPLOAD_HELPER_1ST IMPLEMENTATION.
